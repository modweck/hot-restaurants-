...
for (const [key, v] of Object.entries(raw)) {
  ...
  // Convert string statuses (from resy/ot scripts) to booleans
  if (!has_early && v.early && v.early !== 'booked') has_early = true;
  if (!has_prime && v.prime && v.prime !== 'booked') has_prime = true;
  if (!has_late  && v.late  && v.late  !== 'booked') has_late  = true;
