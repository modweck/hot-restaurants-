(async () => {
  ...
  const NAMES = ["the consulate uws", "bondurants", "oh! calcutta", "aleli", "amaranto", "big tiny", "Aberdeen Barn", "blujeen", "born thai", "bubba gump shrimp co.", "clemente's maryland crab house", "concrete", "da nonna rosa", "don giovanni ristorante", "donna margheritia", "emma's torch", "empanada mama hell's kitchen", "fish village", "giovanni restaurant", "haile bistro", "Il Posto Accanto", "indian summer", "kennedy's restaurant", "kimchi grill", "levante", "lincoln station", "nakamura", "new garden restaurant", "northern bell", "Fork And Vine", "b\u014dm", "patricia's", "patrizia's of williamsburg", "runner & stone", "sea witch", "soup n burger", "summer salt", "sushi ishikawa- ues", "the castello plan", "the keg room", "the spotted owl", "the upper crust", "the waylon", "turntable chicken & rock", "udon lab", "violette's cellar", "vite vinosteria", "Ruta Oaxaca Mexican Cuisine", "casino", "pegasus brooklyn", "house of thai", "geisha asian fusion", "geisha japanese grill", "chateau yaffa", "Noodle Lane and Dumplings", "The Office of Mr Moto", "sophie's cuban cuisine", "guest new york", "urban vegan roots", "china river", "coquito blu", "il giglio", "caravan uyghur cuisine", "commodore ii", "djon djon", "kappo sono", "hearty and healthy", "rice k", "pitt's", "mamasushi williamsburg", "tan", "mockingbird", "el lado taco", "barkada social club", "clara"];

  console.log('[OT Batch 2] ' + NAMES.length + ' restaurants | Date: ' + DATE);
  ...
  console.log('\n' + '='.repeat(40));
  console.log('Batch 2 done! Found: ' + Object.keys(results).length + ' | Bookable: ' + bookable + ' | No match: ' + noMatch + ' | Errors: ' + errors);

  const blob = new Blob([JSON.stringify(results, null, 2)], {type:'application/json'});
  const a = document.createElement('a');
  a.href = URL.createObjectURL(blob);
  a.download = 'ot_batch_2.json';
  a.click();
})();