(async () => {
  ...
  const NAMES = ["taqueria condesa", "La Terraza Mexican Grill", "made in miami", "puerta del alma", "yakiniku great", "the old standard", "bin 71", "roebling sporting club", "hummus place", "harry's italian", "bacaro", "sushi & co", "original pancake house", "awang kitchen", "district saigon", "los burritos juarez", "atlas kitchen", "brooklyn roots collective", "dashi okume brooklyn", "elia restaurant - brooklyn", "gp\u2019s restaurant", "hori", "jj dak", "mathews food & drink", "minka nikkei", "o", "otway", "perla oyster bar", "rulin", "sloane's", "sushi saint", "the saint clair", "third kingdom", "tillie's x wsa", "viv & jules", "zara forest grill", "brbq", "kam rai thai", "el gallo taqueria", "Scottadito Osteria Toscana", "Uluh", "TabeTomo", "NIKU X", "Ramen Ishida", "Isle of Capri", "Bowery Road", "Secchu Yokota", "Sophra Grill", "shabushabu Mayumon", "IL Punto Ristorante", "Pazza Notte", "Ristorante Il Melograno", "Tartine", "Takahachi", "Blossom on Columbus", "Due Restaurant", "The Full Shilling", "Sushi Seki Times Square", "Empanada Mama Les", "Cocoron", "Ho Foods", "Davelle", "Ravagh Persian Grill - Madison Avenue", "Medusa The Greek", "Prode", "Izakaya", "Dumpling N' Dips", "Boon Dee Moo Ka Ta", "Italianissimo Ristorante", "Safina", "Rudraks", "Ramen Misoya", "Le District", "Kung Fu Kitchen", "Ajisen Ramen"];

  console.log('[OT Batch 3] ' + NAMES.length + ' restaurants | Date: ' + DATE);
  ...
  console.log('\n' + '='.repeat(40));
  console.log('Batch 3 done! Found: ' + Object.keys(results).length + ' | Bookable: ' + bookable + ' | No match: ' + noMatch + ' | Errors: ' + errors);

  const blob = new Blob([JSON.stringify(results, null, 2)], {type:'application/json'});
  const a = document.createElement('a');
  a.href = URL.createObjectURL(blob);
  a.download = 'ot_batch_3.json';
  a.click();
})();