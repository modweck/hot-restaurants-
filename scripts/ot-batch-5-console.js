(async () => {
  ...
  const NAMES = ["Taqueria El Chiltepin #3", "At The Wallace", "Suyo Gastrofusion", "Tampopo Kitchen", "BURGERS & GRILL", "Marc179", "96 TEARS", "AMILIAS", "ANAIS", "AVO", "BABY'S BUNS & BUCKETS", "BREAKFAST BY SALT CURE", "CARREAU CLUB", "CREMINI'S", "DAWA'S", "DEITY", "EL CARIBE", "EMBLEM", "FINE TIME", "GLAZE TERIYAKI", "JACK'S FIRE DEPARTMENT", "JAVA", "KAL", "KASAI", "KYO", "LA PARISIENNE", "LITTLE KIRIN", "MEZE", "PASTAGASM", "PESCE LULU", "RUSTY NAIL", "SADIE'S WARD", "TADA", "TAIWANESE YUMMY", "TERANGA", "THE ESTERS", "THE KEEP", "THE LITTLE PIG", "VON", "WERKSTATT", "YUMPLING", "dhamaka", "semma", "adda", "nerina", "tha phraya", "naks", "masalawala & sons", "Concrete Shoals", "Lucky Charlie", "Russ And Daughters Cafe", "Sea", "Stk Meatpacking", "The Modern", "bar", "barbalu bklyn", "Sip & Co.", "Pastrami Queen", "Kung Fu Little Steamed Buns Ramen-HK", "Chef Mom Caf\u00e9: Caf\u00e9 424", "Trattoria L'incontro", "Butcher and Banker Steakhouse", "Yasubee Ramen", "Excellent Dumpling House", "Namkeen", "High L\u00faa", "gtk", "Meyhane Turkish Restaurant", "Sushi by Bou W Hotel", "Fonda Tribeca", "Pilot", "Sushi by Bou Ani Ramen", "The Uptown Garrison", "Bomdama Shabu Shabu", "Baba's Pierogies"];

  console.log('[OT Batch 5] ' + NAMES.length + ' restaurants | Date: ' + DATE);
  ...
  console.log('\n' + '='.repeat(40));
  console.log('Batch 5 done! Found: ' + Object.keys(results).length + ' | Bookable: ' + bookable + ' | No match: ' + noMatch + ' | Errors: ' + errors);

  const blob = new Blob([JSON.stringify(results, null, 2)], {type:'application/json'});
  const a = document.createElement('a');
  a.href = URL.createObjectURL(blob);
  a.download = 'ot_batch_5.json';
  a.click();
})();